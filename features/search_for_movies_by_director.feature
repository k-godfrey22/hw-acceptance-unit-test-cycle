...
Scenario: add a movie "The Help"
  Given I am on the home page
  Then I follow "Add new movie"
  And I should be on the new movie page
  Then I fill in "Title" with "The Help"
  And I select "PG-13" from "Rating"
  And  I fill in "Director" with "Tate Taylor"
  And I press "Save Changes"
  Then I should be on the home page
  And I should see "The Help was successfully created."
  
  
Scenario: sort movies by Release Data
  Given I am on the home page
...
Scenario: delete the movie "Alien"
  Given I am on the details page for "Alien"
  Then  I should not see "Ridley Scott"
  And I press "Delete"
  Then  I should be on the home page
